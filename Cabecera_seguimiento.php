...
<head>
    ...
    <link href="css/sb-admin-seguimiento.min.css" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Calificaciones -->
            <li class="nav-item">
                <a class="nav-link" href="seguimiento.view.php">
                <i><ion-icon name="people" style="color: white; font-size: 18px;"></ion-icon></i>
                    <span style="font-size: 18px;">Seguimiento</span>
                </a>
            </li>
