...
$alumnos = $conn->prepare("select a.id, a.num_lista, a.nombres, a.apellidos, a.genero, b.nombre as grado from alumnos as a inner join grados as b on a.id_grado = b.id order by a.apellidos");
$alumnos->execute();
